    ...
    <div class="main-wrapper">
        ...
        <script type="text/javascript">
            ...
            jQuery(function ($) {
                ...
                $("input#txtExpiryMonth,input#txtExpiryYear ").on('change', function () {
            ...
            function Validate() {
                ...
                var expiryMonth = document.getElementById("<%=txtExpiryMonth.ClientID %>");
                var expiryYear = document.getElementById("<%=txtExpiryYear.ClientID %>");
                ...
                if (txtCvvNumber.value == '') {
                    ...
                    txtCaptcha.value = '';
                    status = false;
                } else if ($(txtCvvNumber).filter(function () {
                    return parseInt(this.value, 10) !== 0;
                }).length === 0) {
                    //console.log('all zeros here');
                    $('#txtCvvNumber').addClass('has-error');
                    $('#lblCvvNumber').show().text('Invalid CVV number.');
                    txtCaptcha.value = '';
                    status = false;
...
//            function reaponsetimeout() {

//                $.ajax({
//                    type: "POST",
//                    url: "Proxy.aspx/GetCurrentTime",
//                    data: 'ResultCode=17&Message=Response Timeout',
...
//            }
            ...
            function chkRememberMe_onclick() {
                ...
                <asp:UpdatePanel ID="CheckOutPanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:Label ID="lbltxntype" runat="server" 
                            Text=" , Please complete this form to process your payment"></asp:Label>
                        <br />
&nbsp;</strong><div class="form-group">
                            <h4 class="amount">
                                <asp:Label ID="lblamounttext" runat="server"></asp:Label>
                                 
                                <asp:Label ID="lblCurrencyValue" runat="server" CssClass="amountCurrency"></asp:Label>&nbsp;&nbsp;<asp:Label ID="lblAmountValue" runat="server" CssClass="amountCurrency"></asp:Label></h4>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group form-group">
                                ...
                                <input name="txtCardNumber" runat="server" id="txtCardNumber" class="input-lg form-control cc-number"
                                    autocomplete="off" placeholder="Enter Card Number" tabindex="1" type="text" />
                                <span class="input-group-addon cardTypeIcon"><i class="default"></i></span>
                            </div>
                            ...
                            <label for="chkRememberMe" class="control-label remember-me" id="lblCheckBox" runat="server">
                                <input id="chkRememberMe" type="checkbox" runat="server" tabindex="2" onclick="return chkRememberMe_onclick()" />
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="date-hold">
                                    <asp:DropDownList ID="txtExpiryMonth" runat="server" TabIndex="3" 
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="captcha" class="control-label">
                                        Type the characters you see </label>
                                &nbsp;<asp:Label ID="lblcaptha" runat="server" Font-Bold="True" 
                                        Text="in the Captcha below"></asp:Label>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <ContentTemplate>
                                        <div class="form-group col-md-7">
                                            <cap:CaptchaControl ID="captNoBot" CssClass="capNoBot col-md-10" runat="server" CaptchaBackgroundNoise="None"
                                                ...
                                                CaptchaChars="ACDEFGHIJKLMNOPQRTUVXYZ2346789" BackColor="#AFB7BC" CustomValidatorErrorMessage="<%$ Resources:REVCheckOut,
                                             captchaMismatch %>" />
                        ...
                        Pay</button>--%>
                                <asp:Button ID="btnPay" CssClass="btn btn-primary btn-pay" runat="server"
