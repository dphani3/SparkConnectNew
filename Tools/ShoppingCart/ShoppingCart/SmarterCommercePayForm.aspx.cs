...
public partial class SmarterCommercePayForm : System.Web.UI.Page
{
    ...
    {
        string checkOutSmarterCommerceUrl = ConfigurationManager.AppSettings["CheckOutSmarterCommerceUrl"].Trim();
        ...
        if(!String.IsNullOrEmpty(checkOutSmarterCommerceUrl))
        {
            ...
            postData.Add("OrderCompany", txtOrderCompany.Text.Trim());                         //Order Company
            postData.Add("OrderNumber", txtOrderNumber.Text.Trim());                           //Order Number
            postData.Add("OrderType", txtOrderType.Text.Trim());                               //Order Type
