<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransactionRequest.aspx.cs"
    Inherits="TransactionRequest" %>
...
<body>
    ...
    <div id="divTransRequest" runat="server">
        <table id="tblConsumerInfo" runat="server" style="border: solid 2px #bbbbbb; margin: 0 auto;
            ...
            <tr>
                ...
                <td align="left" style="border: solid 1px #bbbbbb;">
                    <asp:TextBox ID="txtToken" runat="server" Width="80%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left" style="font-weight: bold; border: solid 1px #bbbbbb;">
                    <asp:Label ID="lblToken0" runat="server" Text="Name:"></asp:Label>
                </td>
                <td align="left" style="border: solid 1px #bbbbbb;">
                    <asp:TextBox ID="txtname" runat="server" Width="527px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left" style="font-weight: bold; border: solid 1px #bbbbbb;">
                    <asp:Label ID="lblToken1" runat="server" Text="CreditCardNumber:"></asp:Label>
                </td>
                <td align="left" style="border: solid 1px #bbbbbb;">
                    <asp:TextBox ID="txtCreditCardNumber" runat="server" Width="528px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left" style="font-weight: bold; border: solid 1px #bbbbbb;">
            ...
            <tr>
                <td align="left" style="font-weight: bold; border: solid 1px #bbbbbb;">
                    <asp:Label ID="lblOrderNumber0" runat="server" Text="Order Number:"></asp:Label>
                </td>
                <td align="left" style="border: solid 1px #bbbbbb;">
            ...
            <tr>
                <td align="left" style="font-weight: bold; border: solid 1px #bbbbbb;">
                    <asp:Label ID="lblOrderNumber" runat="server" Text="Notes:"></asp:Label>
                </td>
                <td align="left" style="border: solid 1px #bbbbbb;">
                    <asp:TextBox ID="txtNotes" runat="server" Width="80%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left" style="font-weight: bold; border: solid 1px #bbbbbb;">
                    <asp:Label ID="lblOrderNumber2" runat="server" Text="CustomerNo:"></asp:Label>
                </td>
                <td align="left" style="border: solid 1px #bbbbbb;">
