...
public partial class SmarterCommQuoteTransactionStatus : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/SmarterCommQuotePayForm.aspx", true);
    }
    ...
    {
        Response.Redirect("~/SavedCardQuoteTransaction.aspx", true);
    }
