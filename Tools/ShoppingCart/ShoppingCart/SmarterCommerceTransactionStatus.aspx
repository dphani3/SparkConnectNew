<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmarterCommerceTransactionStatus.aspx.cs"
    Inherits="SmarterCommerceTransactionStatus" %>
        ...
        <table id="tblTrxStatus" runat="server" style="border: solid 2px #bbbbbb; margin: 0 auto;
            ...
            <tr>
                <td align="center" colspan="2" style="width: 30%; font-weight: bold; border: solid 1px #bbbbbb;">
                    ...
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    <asp:LinkButton ID="lnkbtnSavedCardTransaction" runat="server" Text="Saved Card" OnClick="lnkbtnSavedCard_Click" />
                </td>
            </tr>
        </table>
    </div>
