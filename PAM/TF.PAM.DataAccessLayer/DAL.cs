...
/* Copyright 2010 (c), ThoughtFocus.
  ...
  File Name: DAL.cs
  Description: This is the data access layer for all PAM operations through which it will communicate with database and perform all operations related to database.
...
namespace TF.PAM.DataAccessLayer
{
    #region DAL

    /// <summary>
    /// This is the data access layer for all PAM operations through which it will communicate with database and perform all operations 
    /// related to database.
    /// </summary>
    public class DAL : IDisposable
    {
        ...
        static DAL()
        {
            ...
            dalLogger = LogManager.GetLogger("PAM");
        }
