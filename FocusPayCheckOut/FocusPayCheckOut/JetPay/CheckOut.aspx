                    ...
                    <ContentTemplate>
                        ...
                        <div class="form-group">
                            <h4 class="amount">
                                ...
                                <asp:Label ID="lblAmountValue" runat="server" CssClass="amountCurrency"></asp:Label></h4>
                        </div>
                        <div class="form-group">
                                ...
                                <ContentTemplate>
                                    <div class="form-group col-md-7">
                                        <cap:CaptchaControl ID="captNoBot" CssClass="capNoBot col-md-10" runat="server" CaptchaBackgroundNoise="None"
                                            ...
                                            CaptchaChars="ACDEFGHIJKLMNOPQRTUVXYZ2346789" BackColor="#AFB7BC" CustomValidatorErrorMessage="<%$ Resources:FocusPayCheckOut,
                                             captchaMismatch %>" />
