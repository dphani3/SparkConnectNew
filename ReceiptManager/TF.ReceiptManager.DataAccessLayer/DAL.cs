...
/* Copyright 2011 (c), ThoughtFocus.
  ...
  File Name: DAL.cs
  Description: This is the data access layer for all receipt manager operations through which it will communicate with database and perform all operations.
...
namespace TF.ReceiptManager.DataAccessLayer
{
    #region DAL

    /// <summary>
    /// This is the data access layer for all receipt manager operations through which it will communicate with database and perform all operations.
    /// </summary>
    public class DAL : IDisposable
    {
        ...
        private static readonly ILog dalLogger = null;                      //log4net logger interface.
        ...
        /// <summary>
        /// Static Constructor that initializes the data access layer logger.
        /// </summary>
        static DAL()
        {
            //Initialize the logger.
            dalLogger = LogManager.GetLogger("RMR");
        }
        ...
        public DAL(string connectionStringName)
        {
        ...
        public DataSet GetDataSet(string storedProcedureName, ref int responseCode, params IDataParameter[] parameters)
        {
            ...
            else
            {
                ...
                {
                    dalLogger.Error(String.Format("SqlException on executing {0}", storedProcedureName), errorMessage);
                ...
                {
                    dalLogger.Error(String.Format("Exception on executing {0}", storedProcedureName), errorMessage);
        ...
        public SqlDataReader GetDataReader(string storedProcedureName, ref int responseCode, params IDataParameter[] parameters)
        {
        ...
        public SqlCommand GetSqlCommand(string storedProcedureName, ref int responseCode, params IDataParameter[] parameters)
        {
        ...
        public int ExecuteNonQuery(string storedProcedureName, ref int responseCode, params IDataParameter[] parameters)
        {
            int rowsEffected = 0;
            SqlConnection connection = null;
        ...
        public object ExecuteScalar(string storedProcedureName, ref int responseCode, params IDataParameter[] parameters)
        {
        ...
        public SqlParameter CreateParameter(string parameterName, SqlDbType parameterType, object parameterValue)
        {
        ...
        /// <returns>Sql Parameter.</returns>
        public SqlParameter CreateParameter(string parameterName, SqlDbType parameterType, ParameterDirection direction)
        {
        ...
        /// <param name="direction">Parameter Direction.</param>
        /// <returns>Sql Parameter.</returns>
        public SqlParameter CreateParameter(string parameterName, SqlDbType parameterType, object parameterValue, ParameterDirection direction)
        {
        ...
        /// <returns>Sql Parameter.</returns>
        public SqlParameter CreateParameter(string parameterName, SqlDbType parameterType, object parameterValue, int size)
        {
            SqlParameter sqlParameter = CreateParameter(parameterName, parameterType, parameterValue);
        ...
        /// <param name="direction">Parameter Direction.</param>
        /// <returns>Sql Parameter.</returns>
        public SqlParameter CreateParameter(string parameterName, SqlDbType parameterType, int size, ParameterDirection direction)
        {
            SqlParameter sqlParameter = CreateParameter(parameterName, parameterType, DBNull.Value);
            sqlParameter.Direction = direction;
            sqlParameter.Size = size;
        ...
        /// <param name="direction">Parameter Direction.</param>
        /// <returns>Sql Parameter.</returns>
        public SqlParameter CreateParameter(string parameterName, SqlDbType parameterType, object parameterValue, int size, ParameterDirection direction)
        {
            SqlParameter sqlParameter = CreateParameter(parameterName, parameterType, parameterValue);
            sqlParameter.Direction = direction;
            sqlParameter.Size = size;
        ...
        /// <returns>Sql Parameter.</returns>
        public SqlParameter CreateParameter(string parameterName, SqlDbType parameterType, object parameterValue, int size, byte precision)
        {
            SqlParameter sqlParameter = CreateParameter(parameterName, parameterType, parameterValue);
            sqlParameter.Size = size;
        ...
        /// <param name="direction">Parameter Direction.</param>
        /// <returns>Sql Parameter.</returns>
        public SqlParameter CreateParameter(string parameterName, SqlDbType parameterType, object parameterValue, int size, byte precision, ParameterDirection direction)
        {
            SqlParameter sqlParameter = CreateParameter(parameterName, parameterType, parameterValue);
            sqlParameter.Direction = direction;
            sqlParameter.Size = size;
        ...
        private SqlConnection OpenConnection(string connectionString)
        {
            ...
            {
                dalLogger.Debug("No connection string provided.");
            ...
            else
            {
                ...
                {
                    dalLogger.Error("Exception on opening the connection", errorMessage);
